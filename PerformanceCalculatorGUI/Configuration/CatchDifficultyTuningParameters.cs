...
namespace PerformanceCalculatorGUI.Configuration
{
    public sealed class CatchDifficultyTuningParameter
    {
        ...
        private CatchDifficultyTuningParameter(string uiLabel, string autobalanceLabel, bool isInteger, double autobalanceMinValue, double? autobalanceMaxValue,
                                                bool defaultEnabled,
        ...
        public static CatchDifficultyTuningParameter ForDouble(string uiLabel, string autobalanceLabel, Func<CatchDifficultyConstants, double> getter,
            ...
            => new CatchDifficultyTuningParameter(uiLabel, autobalanceLabel, false, autobalanceMinValue, autobalanceMaxValue, defaultEnabled, getter, setter);
        ...
        public static CatchDifficultyTuningParameter ForInt(string uiLabel, string autobalanceLabel, Func<CatchDifficultyConstants, int> getter,
            ...
            => new CatchDifficultyTuningParameter(uiLabel, autobalanceLabel, true, autobalanceMinValue, autobalanceMaxValue, defaultEnabled,
    ...
    public static class CatchDifficultyTuningParameters
    {
                                                                   ...
                                                                   bool defaultEnabled = true, double minValue = 0.01, double? maxValue = null)
        {
            ...
            return CatchDifficultyTuningParameter.ForDouble(label, label, getter, setter, defaultEnabled, minValue, maxValue);
        }
        ...
        {
            string label = propertyName.Humanize();
            return CatchDifficultyTuningParameter.ForInt(label, label, getter, setter, defaultEnabled, minValue, maxValue);
        }
    }
}
