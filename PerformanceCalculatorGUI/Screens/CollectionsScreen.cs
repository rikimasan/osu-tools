...
namespace PerformanceCalculatorGUI.Screens
{
    public partial class CollectionsScreen : PerformanceCalculatorScreen
    {
        ...
        private static AutobalanceParameter[] createAutobalanceParameters() => new[]
        {
            ...
            AutobalanceParameter.ForDouble("Flashlight perf", t => t.FlashlightPerformanceScale, (t, v) => t with { FlashlightPerformanceScale = v }, true),
            AutobalanceParameter.ForDouble("Total perf", t => t.TotalPerformanceScale, (t, v) => t with { TotalPerformanceScale = v }, true),
            AutobalanceParameter.ForDouble("Aim strain", t => t.AimSkillStrainScale, (t, v) => t with { AimSkillStrainScale = v }, false),
            AutobalanceParameter.ForDouble("Speed strain", t => t.SpeedSkillStrainScale, (t, v) => t with { SpeedSkillStrainScale = v }, false),
            ...
            AutobalanceParameter.ForDouble("Aim wide angle", t => t.AimWideAngleBonusScale, (t, v) => t with { AimWideAngleBonusScale = v }, false),
            AutobalanceParameter.ForDouble("Aim acute angle", t => t.AimAcuteAngleScale, (t, v) => t with { AimAcuteAngleScale = v }, false),
            AutobalanceParameter.ForDouble("Aim slider bonus", t => t.AimSliderBonusScale, (t, v) => t with { AimSliderBonusScale = v }, false),
            AutobalanceParameter.ForDouble("Aim velocity bonus", t => t.AimVelocityChangeBonusScale, (t, v) => t with { AimVelocityChangeBonusScale = v }, false),
            AutobalanceParameter.ForDouble("Aim wiggle bonus", t => t.AimWiggleBonusScale, (t, v) => t with { AimWiggleBonusScale = v }, false),
            ...
            AutobalanceParameter.ForInt("Rhythm history ms", t => t.RhythmHistoryTimeMax, (t, v) => t with { RhythmHistoryTimeMax = v }, false),
            AutobalanceParameter.ForInt("Rhythm history objs", t => t.RhythmHistoryObjectsMax, (t, v) => t with { RhythmHistoryObjectsMax = v }, false),
            AutobalanceParameter.ForDouble("Rhythm overall", t => t.RhythmOverallScale, (t, v) => t with { RhythmOverallScale = v }, false),
            AutobalanceParameter.ForDouble("Rhythm ratio", t => t.RhythmRatioScale, (t, v) => t with { RhythmRatioScale = v }, false),
            AutobalanceParameter.ForDouble("Speed spacing", t => t.SpeedSingleSpacingThreshold, (t, v) => t with { SpeedSingleSpacingThreshold = v }, false),
            AutobalanceParameter.ForDouble("Speed min bpm", t => t.SpeedMinBonusBpm, (t, v) => t with { SpeedMinBonusBpm = v }, false),
            AutobalanceParameter.ForDouble("Speed balance", t => t.SpeedBalancingFactor, (t, v) => t with { SpeedBalancingFactor = v }, false),
            AutobalanceParameter.ForDouble("Speed distance", t => t.SpeedDistanceScale, (t, v) => t with { SpeedDistanceScale = v }, false),
        };
